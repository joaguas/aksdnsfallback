...
A reboot should address the issue but when this is not possible/feasible ~~we can rely on systemd-resolved itself and configure a fallback nameserver which will ensure there will always be a nameserver~~ we can use dhclient to renew dhcp information and get the DNS server.
...
```
wget https://raw.githubusercontent.com/joaguas/aksdnsfallback/main/individualnodedhcp.yaml
...
```
kubectl apply -f https://raw.githubusercontent.com/joaguas/aksdnsfallback/main/dnsdhclientfix.yaml
```
